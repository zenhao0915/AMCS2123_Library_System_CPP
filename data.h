...
inline User *currentUser = nullptr;
...
inline bool isUserIdDuplicate(const string &id, const vector<User> &users) {
...
inline bool isUserNameDuplicate(const string &name, const vector<User> &users) {
    for (const auto &user: users) {
...
inline void registerUser(vector<User> &users, const string &userID, const string &username, const string &password) {
...
inline void loginToUser(vector<User> &users, const string &userID, const string &password) {
    for (auto & user : users) {
